 ...
 * {@link AgentLoop} 只需传入多轮消息并调用 {@link #completeChat(JsonArray)}，以及 {@link #bashToolName()} 用于工具分发。
 *
 * @author 298751
 */
public final class LLMClient {
    ...
    /**
     * 本示例中 bash 工具在 {@link AgentConfig#tools()} 中的名称，供循环侧识别是否由 {@link BashTool} 执行。
     */
